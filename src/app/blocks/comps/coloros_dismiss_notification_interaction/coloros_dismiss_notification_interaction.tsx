...
import { MessageCircle, Settings, Trash, User } from "lucide-react";
import { useRef, useState } from "react";

const ColorOsDismissNotification = () => {
              ...
              <div className="flex gap-2 items-center">
                ...
                <div>
                  <p className="text-xs leading-relaxed text-neutral-600">
                    Dear customer, you do not have an active data bundle. Please
                    dial <span>*544#</span> to buy data bundle for you to browse
                    the internet
                  </p>
                </div>
              </div>
...
export default ColorOsDismissNotification;
